...
<div class="card">
    <div class="card-header">
        <h5 class="mb-2">Edit Penerimaan</h5> <br>
    ...
    <div class="card-block">
        <h4 class="sub-title">Edit Penerimaan</h4>
        ...
        <form  class="forms-sample mt-2" enctype="multipart/form-data" action="{{ route('penerimaan.update',$penerimaan['id'])}}" method="post">
            @csrf 
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $penerimaan['reff'] }}"  class="form-control {{ $errors->first('reff') ? "is-invalid":""}}" class="form-control" name="reff" placeholder="no.kwitansi/kupon/struik ATM"/>
                                        @error('reff')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $penerimaan['nama_bs'] }}"  class="form-control {{ $errors->first('nama_bs') ? "is-invalid":""}}" class="form-control" name="nama_bs" placeholder="nama bukti setor"/>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" value="{{ $penerimaan['tgl'] }}"  class="form-control {{ $errors->first('tgl') ? "is-invalid":""}}" class="form-control" name="tgl"/>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="relawan">
                                            ...
                                            @foreach ($relawan as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['users_id'] ? 'selected' : ''}}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="lembaga">
                                            ...
                                            @foreach ($lembaga as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['lembaga_id'] ? 'selected' : ''}}>{{ $r->nama_lembaga }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="donatur">
                                            ...
                                            @foreach ($donatur as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['donatur_id'] ? 'selected' : ''}}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="relasi">
                                            ...
                                            @foreach ($relasi as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['relasi_id'] ? 'selected' : ''}}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="program">
                                            ...
                                            @foreach ($program as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['prog_penerimaan_id'] ? 'selected' : ''}}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('program')
                                            <div class="alert alert-danger mt-2">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" value="{{ $penerimaan['nominal']}}"  class="form-control {{ $errors->first('reff') ? "is-invalid":""}}" class="form-control" name="nominal" placeholder="masukan nominal"/>
                                        @error('nominal')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" value="{{ $penerimaan['tgl_tf'] }}"  class="form-control {{ $errors->first('tgl_tf') ? "is-invalid":""}}" class="form-control" name="tgl_tf"/>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="rekening">
                                            ...
                                            @foreach ($rekening as $r)
                                              <option value="{{ $r->id }}" {{$r->id == $penerimaan['rekening_id'] ? 'selected' : ''}}>{{$r->bank}} - {{ $r->nama_pemilik_rekening }} - {{$r->no_rek}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        @if ($penerimaan['bukti'])  
                                            <img src="{{ asset('storage/'.$penerimaan['bukti'])}}" width="120px" alt="gambar">                       
                                        @else

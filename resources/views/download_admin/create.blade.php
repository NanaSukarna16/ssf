...
<div class="card">
    <div class="card-header">
        <h5 class="mb-2">Tambah Download</h5> <br>
    ...
    <div class="card-block">
        <h4 class="sub-title">Tambah Download Baru</h4>
       
        <form  class="forms-sample mt-2" enctype="multipart/form-data" action="{{ route('download.store') }}" method="post">
            @csrf

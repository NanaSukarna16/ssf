        ...
        <button class="btn hor-grd btn-grd-info" data-toggle="modal" data-target="#exampleModal" type="button">
         ...
         <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Visi, Misi dan Legalitas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
                <div class="modal-body">
                    <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{route('visi.store')}}">
                    @csrf
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <textarea name="visi" id="visi" class="form-control" rows="10">{{old('visi')}}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <textarea name="misi" id="misi" class="form-control" rows="10">{{old('misi')}}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <textarea name="legalitas" id="legalitas" class="form-control" rows="10">{{old('legalitas')}}</textarea>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <label class="login2 pull-right pull-right-pro">Gambar Legalitas</label>
                            </div>
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->visi}}</td>
                        <td>{{$item->misi}}</td>
                        <td>{{$item->legalitas}}</td>
                        <td>
                            <a href="#" class="myImg">
                                <img src="{{asset('storage/legalitas/'.$item->img_legalitas)}}" alt="image" width="70px"/>
                            </a> 
                        </td>
                        <td>
                            <a href="{{route('visi.edit', $item->id)}}">
                                <button class="btn btn-warning btn-outline-warning btn-icon"  data-target="#exampleModal2" type="button">
                                    <i class="ti-pencil-alt"></i>
                                </button>
                            </a>       
                            <a href="{{route('visi.destroy', $item->id)}}">

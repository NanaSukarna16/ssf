...
<div class="card">
    ...
    <div class="card-block">
        <h4 class="sub-title">Edit SSF</h4>
        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('struktur.update',$struktur['id'])}}">
            @csrf
            <div class="form-group-inner">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <input type="text" value="{{ $struktur['nama']}}"  class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" class="form-control" name="nama" placeholder="masukan nama"/>
                        @error('nama')
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <input type="text" value="{{ $struktur['jabatan'] }}"  class="form-control {{ $errors->first('jabatan') ? "is-invalid":""}}" class="form-control" name="jabatan" placeholder="masukan jabatan"/>
                        @error('jabatan')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <select class="form-control {{ $errors->first('tentang_id') ? "is-invalid":""}}" name="tentang_id">
                            ...
                            <option value="{{ $item->id }}" {{$item->id == $struktur['tentang_id'] ? 'selected' : ''}}>{{ $item->nama }}</option>
                            @endforeach
                        </select>
                        @error('tentang_id')
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        @if ($struktur['img'])  
                            <img src="{{ asset('storage/nazhir/'.$struktur['img'])}}" width="120px" alt="gambar">                       
                        @else

...
<div class="card">
    <div class="card-header">
        <h5 class="mb-2">Tambah Donatur</h5> <br>
    ...
    <div class="card-block">
        <h4 class="sub-title">Tambah Donatur Baru</h4>
        ...
        <form  class="forms-sample mt-2" enctype="multipart/form-data" action="{{ route('donatur.store') }}" method="post">
            @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('nama')}}"  class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" class="form-control" name="nama" placeholder="masukan nama donatur"/>
                                @error('nama')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('kode')}}"  class="form-control {{ $errors->first('kode') ? "is-invalid":""}}" class="form-control" name="kode" placeholder="masukan kode"/>
                                @error('kode')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('hp')}}"  class="form-control {{ $errors->first('hp') ? "is-invalid":""}}" class="form-control" name="hp" placeholder="masukan phone donatur"/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('email')}}"  class="form-control {{ $errors->first('email') ? "is-invalid":""}}" class="form-control" name="email" placeholder="email donatur"/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('npwp')}}"  class="form-control {{ $errors->first('npwp') ? "is-invalid":""}}" class="form-control" name="npwp" placeholder="npwp"/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('npwz')}}"  class="form-control {{ $errors->first('npwz') ? "is-invalid":""}}" class="form-control" name="npwz" placeholder="npwz"/>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" value="{{ old('ktp')}}"  class="form-control {{ $errors->first('ktp') ? "is-invalid":""}}" class="form-control" name="ktp" placeholder="32082xxxxxx"/>

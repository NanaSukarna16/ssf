    ...
    <div class="all-title-box" style="background-image: url({{ asset('template_fe')}}/images/about1.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Proram</h2>
                    <ul class="breadcrumb" style="background-color: #fbb714">
                        ...
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
                                    <span>Program SEBI SOCIAL FUND </span>
								</select>
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 text-center text-sm-right">
                                <ul class="nav nav-tabs ml-auto">
                                    <li>
                                        <a class="nav-link active" style="background-color: #fbb714" href="#grid-view" data-toggle="tab"> <i class="fa fa-th"></i> </a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a style="background-color: #fbb714" href="{{ route('program.show', $item->id)}}" data-toggle="tooltip" data-placement="right" title="Lihat"><i class="fas fa-eye"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <a href="{{ route('program.show', $item->id)}}">
                                                        <h2 class="mb-3"><b>{{ $item->nama }}</b></h2>
                                                    </a>
                                                    <div class="progress">
                                                    ...
                                                    <div class="float-right mt-3">
                                                        <h4>Durasi</h4>
                                                        <h5 style="background-color: #fbb714"> {{ \Carbon\Carbon::parse( $item->waktu_awal )->diffInDays( $item->waktu ) }} Hari Lagi</h5>
                                                    </div>
                                                    <h4 class="mt-3">Terkumpul</h4>
                                                    <h5 style="background-color: #fbb714"> Rp {{number_format($item->jumlah ?? 0, 2)}}</h5>
                                                </div>
                                            </div>
                                        </div>                                          
                                        @endforeach

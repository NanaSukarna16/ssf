...
<div class="card">
    <div class="card-header">
        <h5 class="mb-2">Tambah Relawan</h5> <br>
    ...
    <div class="card-block">
        <h4 class="sub-title">Tambah Relawan Baru</h4>
        ...
        <form  class="forms-sample mt-2" enctype="multipart/form-data" action="{{ route('relawan.store') }}" method="post">
            @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ old('nama')}}"  class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" class="form-control" name="nama" placeholder="masukan nama Relawan"/>
                                @error('nama')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" value="{{ old('email')}}"  class="form-control {{ $errors->first('email') ? "is-invalid":""}}" class="form-control" name="email" placeholder="masukan NIM"/>
